...
module.exports = {
    // I. 必须的配置（一定要写）
    server: `ws://172.26.166.36:9090`, // 填写前一节中部署的 xtransit-server 地址
    ...
    errors: [`${rootPath}/log/node-20211124.log`], // 数组，每一项为配置需要监控的 error 日志文件全路径
    packages: [`${rootPath}/package.json`], // 数组，每一项为配置需要监控的 package.json 文件全路径，并且要保证存在平级的 lock 文件（package-lock.json 或者 yarn.lock）
